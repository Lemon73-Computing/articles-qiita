...
tags:
  ...
  - MAUI
private: true
updated_at: '2024-11-26T23:51:01+09:00'
...
.NET 8 の時点では .NET 9 か 10 までにある程度使えるようになったらいいな…と言われていましたが、.NET 9 には全く間に合いませんでした。早くて .NET 10[^net10]、もしくはそれ以降になると思われます。
...
(これに関しては、Thomas Mielke 氏が Docker の作業環境を整えてくれました: [GtkSharp 用](https://github.com/Thomas-Mielke-Software/GtkSharp-Docker), [maui-linux 用](https://github.com/Thomas-Mielke-Software/maui-docker))
