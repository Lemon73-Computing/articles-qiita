...
Avalonia や Uno、Eto、gir.core、photino なども素晴らしいソリューションで、選択肢として良いものだと感じます。しかし、私は Microsoft が直接開発し、広いコミュニティーを形成している .NET MAUI が正式に Linux 対応することにより、そのコミュニティーはより巨大になることができ、多くの人が利用するフレームワークになると考えます。(また Blazor との相互運用も強力であり、Linux 上でもその恩恵を享受できるのは素晴らしいことだと感じます)
