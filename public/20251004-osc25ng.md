...
tags:
  ...
  - osc25ng
private: false
updated_at: '2025-10-05T00:49:13+09:00'
...
(初参加なので間違っているかもしれませんが、) 大半の人は OSC ガチ勢で、学生は2-3人程度、私のような初参加の人は少ない印象でした。
...
すごい…。けど、技術レベルが高すぎて、自分の知識ではわからない部分が多かったです。(あと、Raspberry Pi 上で BSD を動かしていた)
...
(GDS は、データを GPU メモリに直接コピーできる特殊仕様。Geforce には搭載されていないが、A\*000シリーズや、Ada などのサーバー向け GPU には搭載されている)
...
「Oracle からの置換」で調べられるのか…。かなり精度が高そうでした。
