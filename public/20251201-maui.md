---
title: '[.NET MAUI] .NET MAUI on Linux のサンプルを動かしてみる'
tags:
  - Linux
  - C#
  - .NET
  ...
  - MAUI
private: true
updated_at: '2025-11-21T01:12:40+09:00'
...
現時点ではサンプルアプリケーションは動かせる状態です。しかし、既存の .NET MAUI アプリケーションに Linux 対応を追加できる段階までは進んでいません。開発中です・
...
今回は WSL を利用していますが、実機の Linux でも動かせたと思います。
...
- Docker (または Podman)
  ...
  - 私の WSL 環境では Docker で GUI がなかなか動かなかったため、Podman を利用しています
