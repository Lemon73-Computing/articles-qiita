...
tags:
  ...
  - Libicu
private: false
updated_at: '2026-03-12T20:48:12+09:00'
...
[C# Advent Calendar 2025](https://qiita.com/advent-calendar/2025/csharplang) 5日目の記事です。
...
つまり、`LibICU` というパッケージのバージョン `78` か `77` か `76` か `72` が必要なのに、どれもインストールされていないことですね。
